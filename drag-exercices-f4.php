...
<body>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="der Sessel">der Sessel
      </div>

      <div class="empty" id="das Huhn">das Bild
      </div>

      <div class="empty" id="Erdbeeren">der Teppich
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="der Kühlschrank">der Kühlschrank
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices-f5.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'der Kühlschrank') {
        this.append(fill);
        document.getElementById("der Kühlschrank").style.borderColor = "green";
