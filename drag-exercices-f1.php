...
<body>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                ...
                                <li class="current-item"><a href="./service-n.php">Services</a></li class="current-item">
          ...
          <div class="breadcumb--con">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="service-n.php"></i> Service</a></li>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="der Hund">das Fenster
      </div>

      <div class="empty" id="das Huhn">der Vorhang
      </div>

      <div class="empty" id="das Handtuch">das Handtuch
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="Weinbeere">der Spiegel
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices-f2.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'das Handtuch') {
        this.append(fill);
        document.getElementById("das Handtuch").style.borderColor = "green";
