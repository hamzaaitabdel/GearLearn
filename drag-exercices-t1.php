...
<body>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="der Hund">der Hund
      </div>

      <div class="empty" id="das Huhn">das Huhn
      </div>

      <div class="empty" id="Erdbeeren">das Schwein
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="Weinbeere">der Wolf
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices-t2.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'der Hund') {
        this.append(fill);
        document.getElementById("der Hund").style.borderColor = "green";
