...
<body>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="die Tür">die Tür
      </div>

      <div class="empty" id="das Huhn">das Spülbecken
      </div>

      <div class="empty" id="Erdbeeren">der Fernseher
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="Weinbeere">der Stuhl
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices-f3.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'die Tür') {
        this.append(fill);
        document.getElementById("die Tür").style.borderColor = "green";
