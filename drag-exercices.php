...
<div class="empty" id="qst" style="margin-left: 240px;"> 
 ...
 <br>
  <div class="empty" id="apfel">Apfel
  </div>

  <div class="empty" id="orange">Orange
  </div>

  <div class="empty" id="limon">Limon
  </div>

  <div class="empty" id="trauben">Trauben
</div>
</div>
...
<br>
<a href="./drag-exercices1.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
<br>
</br>
