...
<div class="empty" id="qst" style="margin-left: 240px;">
 ...
 <br>
  <div class="empty" id="Kirschen">Kirschen
  </div>

  <div class="empty" id="Kartoffeln ">Kartoffeln 
  </div>

  <div class="empty" id="Knoblauch">Knoblauch
  </div>

  <div class="empty" id="Möhren">Möhren
</div>
</div>
...
<br>
<a href="./drag-exercices4.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
<br>
</br>
...
<script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if(e.target.id =='Kirschen'){
        this.append(fill);
        document.getElementById("Kirschen").style.borderColor="green";
  ...
  var newvalue=((parseInt(document.getElementById("bar1").clientWidth)*20.635)/100)+20;
  ...
  localStorage.removeItem("richtig");
    ...
    else{if(e.target.id=="qst"){}
    else{
      var newvalue=((parseInt(document.getElementById("bar2").clientWidth)*20.635)/100)+20;
      newvalue=Math.round(newvalue);
      ...
      document.getElementById("f").draggable=false;
      setTimeout(function(){ document.getElementById("Kirschen").style.borderColor="green"},500);
      document.getElementById("f").draggable=false;
        ...
        * {
        ...
        .uza-contact-form {
          ...
          .uza-contact-form textarea.form-control {
            ...
            .fill{
              background-image: url('Kirschen.png');
              position: relative;
              height: 150px;
              width: 150px;
              top: 2px;
