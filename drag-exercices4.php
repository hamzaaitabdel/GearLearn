...
<div class="empty" id="qst" style="margin-left: 240px;">
 ...
 <br>
  <div class="empty" id="Nüsse">Nüsse
  </div>

  <div class="empty" id="Paprika">Paprika
  </div>

  <div class="empty" id="Pilze">Pilze
  </div>

  <div class="empty" id="Melone">Melone
</div>
</div>
...
<script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if(e.target.id =='Melone'){
        this.append(fill);
        document.getElementById("Melone").style.borderColor="green";
  ...
  localStorage.removeItem("richtig");
      ...
      document.getElementById("f").draggable=false;
      setTimeout(function(){ document.getElementById("Melone").style.borderColor="green"},500);
      document.getElementById("f").draggable=false;
        ...
        * {
        ...
        .uza-contact-form {
          ...
          .uza-contact-form textarea.form-control {
            ...
            .fill{
              background-image: url('melone.png');
              position: relative;
              height: 150px;
              width: 150px;
              top: 2px;
