...
<body>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="der Löwe">der Löwe
      </div>

      <div class="empty" id="der Leopard">der Leopard
      </div>

      <div class="empty" id="der Panther">der Panther
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="der Gepard">der Gepard
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices-t4.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'der Löwe') {
        this.append(fill);
        document.getElementById("der Löwe").style.borderColor = "green";
