...
<body>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="der Hund">die Wand
      </div>

      <div class="empty" id="das Huhn">die Kommode
      </div>

      <div class="empty" id="die Treppen">die Treppen
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="Weinbeere">der Vorhang
      </div>
    </div>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'die Treppen') {
        this.append(fill);
        document.getElementById("die Treppen").style.borderColor = "green";
