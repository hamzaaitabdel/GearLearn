...
<body>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="das Eichhörnchen">das Eichhörnchen
      </div>

      <div class="empty" id="der Bär">der Bär
      </div>

      <div class="empty" id="der Igel">der Igel
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="die Spinne">die Spinne
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices-t3.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'der Bär') {
        this.append(fill);
        document.getElementById("der Bär").style.borderColor = "green";
