...
<body>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="Aprikose">Aprikose
      </div>

      <div class="empty" id="Olive">Olive
      </div>

      <div class="empty" id="Erdbeeren">Erdbeeren
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="Weinbeere">Weinbeere
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices2.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'Erdbeeren') {
        this.append(fill);
        document.getElementById("Erdbeeren").style.borderColor = "green";
