...
<body>
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    <li><a class="search-icon" data-toggle="modal" href="#"><i
                                                class="icon_profile"></i>Username</a>
                                        <ul class="dropdown">
                                            <style>
                                                body {
                                                    font-family: Arial, Helvetica, sans-serif;
          ...
          <div class="breadcumb--con">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Möbel</li>
              </ol>
            </nav>
          </div>
        </div>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="der Hund">das Regal 
      </div>

      <div class="empty" id="der Schreibtisch">der Schreibtisch
      </div>

      <div class="empty" id="Erdbeeren">die Decke
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="Weinbeere">das Geschirr
      </div>
    </div>
  ...
  <br>
  <a href="./drag-exercices-f4.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'der Schreibtisch') {
        this.append(fill);
        document.getElementById("der Schreibtisch").style.borderColor = "green";
