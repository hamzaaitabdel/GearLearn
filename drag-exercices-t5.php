...
<body>
          ...
          <div class="breadcumb--con">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tier</li>
              </ol>
            </nav>
          </div>
        </div>
  ...
  <div class="grid-container">
    <div class="grid-item">
      ...
      <br>
      <div class="empty" id="der Delfin">der Delfin
      </div>

      <div class="empty" id="der Affe">der Affe
      </div>

      <div class="empty" id="der Hirsch">der Hirsch
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="die Biene">die Biene
      </div>
    </div>
  ...
  <br>
  <a href="drag-exercices-results.html" class="botona" data-animation="fadeInUp" data-delay="700ms">Results</a>
  <br>
  </br>
  ...
  <script>const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'der Hirsch') {
        this.append(fill);
        document.getElementById("der Hirsch").style.borderColor = "green";
