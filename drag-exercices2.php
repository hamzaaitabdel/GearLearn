...
<div class="empty" id="qst" style="margin-left: 240px;">
 ...
 <br>
  <div class="empty" id="Bananen">Bananen
  </div>

  <div class="empty" id="Avocado">Avocado
  </div>

  <div class="empty" id="Birnen">Birnen
  </div>

  <div class="empty" id="Gurke">Gurke
</div>
</div>
...
<br>
<a href="./drag-exercices3.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
<br>
</br>
...
const fill = document.querySelector('.fill');
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if(e.target.id =='Birnen'){
        this.append(fill);
        document.getElementById("Birnen").style.borderColor="green";
  ...
  localStorage.removeItem("richtig");
        ...
        console.log(localStorage.getItem("richtig"));
    }
      ...
      setTimeout(function(){ document.getElementById("Birnen").style.borderColor="green"},500);
      document.getElementById("f").draggable=false;
