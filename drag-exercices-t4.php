...
<body>
                            ...
                            <div class="classynav">
                                ...
                                <div id="myModal1" class="modal">
                                    ...
                                    <div class="card">
                                        ...
                                        <p><button>Deconnection</button></p>
                                    </div>
          ...
          <div class="breadcumb--con">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="services-n.php"></i> Service</a></li>
                <li class="breadcrumb-item"><a href="drag-exercices-menu.html"></i> Drag Exercices</a></li>
                <li class="breadcrumb-item active" aria-current="page">Obst</li>
              </ol>
            </nav>
          </div>
        </div>
  ...
  <div class="grid-container">
    <div class="grid-item">
      <div class="empty" id="qst" style="margin-left: 240px;">
        <div class="fill" id="f" draggable="true"> </div>
      </div>
      <br>
      <div class="empty" id="die Schlange">die Schlange
      </div>

      <div class="empty" id="der Vogel">der Vogel
      </div>

      <div class="empty" id="der Papagei">der Papagei
        <div ondrop="ajouter()"></div>

      </div>

      <div class="empty" id="das Kaninchen">das Kaninchen
      </div>
    </div>
    <div class="grid-item" style="align-items: center;">
      <div class="col-sm-10">
        <h3 class="progress-title">Richtige Antworte</h3>
        <div class="progress">
          <div class="progress-bar" style="width:0%; background:#97c513; " id="bar1">
            <div class="progress-value" >0%</div>
          </div>
        </div>
        <h3 class="progress-title">Falsche Antworte</h3>
        <div class="progress">
          <div class="progress-bar" style="width:0%; background:#f2545b;" id="bar2">
            <div class="progress-value">0%</div>
          </div>
        </div>
      </div>
  ...
  <br>
  <a href="./drag-exercices-t5.php" class="botona" data-animation="fadeInUp" data-delay="700ms">Next</a>
  <br>
  </br>
  <div class="snackbar" id="richtig" style="background-color: #97C513">Richtig :) !</div>
  <div id="falsch" class="snackbar" style="background-color: #f2545b">Falsch :( !</div>
  <script>const fill = document.querySelector('.fill');
    const empties = document.querySelectorAll('.empty');
    document.getElementById("bar1").style.width=localStorage.getItem("richtig")+"%";
    document.getElementById("bar1").textContent=localStorage.getItem("richtig")+"%";
    document.getElementById("bar2").style.width=localStorage.getItem("falsch")+"%";
    document.getElementById("bar2").textContent=localStorage.getItem("falsch")+"%";
    // Fill listeners
    ...
    function dragDrop(e) {
      this.className = 'empty';
      if (e.target.id == 'das Kaninchen') {
        this.append(fill);
        document.getElementById("das Kaninchen").style.borderColor = "green";
        document.getElementById("f").draggable = false;
        var x = document.getElementById("richtig");
        x.classList.add("show");
        setTimeout(function () { x.className = x.className.replace("show", ""); }, 3000);
        var note = parseInt(localStorage.getItem("note"));
        var newvalue=((parseInt(document.getElementById("bar1").offsetWidth)*20.635)/100)+20;
   ...
   document.getElementById("bar1").textContent=newvalue+"%";
        ...
        if (e.target.id == "qst") { }
          ...
          console.log(window.getComputedStyle(document.getElementById("bar2")).width);
          var newvalue=((parseInt(document.getElementById("bar2").offsetWidth)*20.635)/100)+20;
          newvalue=Math.round(newvalue);
      ...
      document.getElementById("bar2").textContent=newvalue+"%";
          ...
          setTimeout(function () { document.getElementById("Erdbeeren").style.borderColor = "green" }, 500);
          document.getElementById("f").draggable = false;
